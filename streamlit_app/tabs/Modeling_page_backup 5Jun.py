...
def machine_learning_modelling():
    ...
    st.info("• Réduction de la taille d'environ de 40% grâce à la fonction resize pour charger les images au format 224x224 pixels ; \
             • Passage despixels des canaux de couleur en image en noir et blanc ; \
             • Sélection des 20% de pixels les plus porteurs d'information pour l'algorithme SelectPercentile ; \
...
def deep_learning_modelling():
    ...
    if option2 == "CNN fonction d'activation":
