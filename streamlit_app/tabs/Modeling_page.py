...
def machine_learning_modelling():
    ...
    if option1 == "Random Forest":
        ...
        st.write("La performance de précision sur les données test ainsi que le score moyen affichent un résultat de 0,76.")
...
def deep_learning_modelling():
    ...
    liste_model2 = ["", "LeNet", "CNN fonction d'activation variée"]
    ...
    if option2 == "CNN fonction d'activation variée":
        ...
        st.image(image_2, caption="Matrice de confusion")
